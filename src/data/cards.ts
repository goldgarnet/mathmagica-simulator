...
export const equipmentDefs: EquipmentDef[] = [
  {
    ...
    activeUse: { cost: { type: 'mana', amount: 1 }, label: '마법열 카드 회수' },
  },
  {
    id: 'equip-predator-hat', name: '포식자의 모자', slot: 'hat', rarity: 'rare',
    effectDescription: '적을 처치할 때마다 각인 1 (패시브)',
  ...
  },
  {
    ...
    activeUse: { cost: { type: 'mana', amount: 5 }, label: '갈래 번개 시전' },
  },
  {
    ...
    activeUse: { cost: { type: 'oncePerScenario' }, label: '7 영창 + 발동' },
  },
  {
  ...
  },
  {
    ...
    activeUse: { cost: { type: 'oncePerScenario' }, label: '카드 1장 + 4 영창' },
  },
  {
  ...
  },
  {
    ...
    activeUse: { cost: { type: 'mana', amount: 2 }, label: '생명력 흡수' },
  },
  {
    ...
    activeUse: { cost: { type: 'mana', amount: 4 }, label: '융합 발동' },
  },
  {
    ...
    effectId: 'chromatica',
    activeUse: { cost: { type: 'mana', amount: 3 }, label: '오메가 시전' },
  },
  // Tutorial equipment
  {
  ...
  },
  {
    ...
    activeUse: { cost: { type: 'oncePerScenario' }, label: '불(3) 한 장 획득' },
  },
];
